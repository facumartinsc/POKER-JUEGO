...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        jugador1NombreLabel.text = "Jugador 1: \(jugador1 ?? "")"
        jugador2NombreLabel.text = "Jugador 2: \(jugador2 ?? "")"
    ...
    func IniciarJuego() {
        ...
        if resultado.contains("Jugador 1") {
            ...
            mensajeAlerta = "Ganó \(jugador1 ?? "Jugador 1") con \(jugada1)"
            ...
            mensajeAlerta = "Empate entre \(jugador1 ?? "Jugador 1") y \(jugador2 ?? "Jugador 2")"
        }
