...
class pokerViewController: UIViewController {
    ...
    @IBOutlet weak var jugador1NombreLabel: UILabel!
    @IBOutlet weak var jugador2NombreLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        jugador1NombreLabel.text = "Jugador: \(SessionManager.shared.nombreUser)"
        jugador2NombreLabel.text = "Jugador 2: ChatGPT"
        
        //jugador1TextField.isHidden = true
        //jugador2TextField.isHidden = true
        
        if let nombre1 = jugador1 {
            //jugador1TextField.text = nombre1
        }
        
        if let nombre2 = jugador2 {
            //jugador2TextField.text = nombre2
        }
    }
    ...
    func IniciarJuego() {
        ...
        if resultado.contains("Jugador 1") {
            mano1StackViews.backgroundColor = UIColor.green.withAlphaComponent(0.4)
            mano2StackViews.backgroundColor = UIColor.red.withAlphaComponent(0.4)
            mensajeAlerta = "Ganó \(SessionManager.shared.nombreUser) con \(jugada1)"
        } else if resultado.contains("Jugador 2") {
            mano1StackViews.backgroundColor = UIColor.red.withAlphaComponent(0.4)
            mano2StackViews.backgroundColor = UIColor.green.withAlphaComponent(0.4)
            mensajeAlerta = "Ganó \(jugador2 ?? "Jugador 2") con \(jugada2)"
        } else {
            mano1StackViews.backgroundColor = .gray
            mano2StackViews.backgroundColor = .gray
            mensajeAlerta = "Empate entre \(SessionManager.shared.nombreUser) y \(jugador2 ?? "Jugador 2")"
        }
    ...
    func determinarGanador(jugada1: String, cartas1: [[String: Any]],
        ...
        if valor1 > valor2 {
            return "Ganó el \(SessionManager.shared.nombreUser) con \(jugada1)"
